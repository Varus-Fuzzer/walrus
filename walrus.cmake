...
ELSEIF (${WALRUS_OUTPUT} STREQUAL "static_lib" OR ${WALRUS_OUTPUT} STREQUAL "fuzzer")
...
ELSEIF (${WALRUS_OUTPUT} STREQUAL "fuzzer")
    # fuzzer 전용 소스
    ADD_EXECUTABLE(${WALRUS_TARGET}
        ${WALRUS_SRC_LIST}
        ${WALRUS_ROOT}/src/fuzzer.cpp
    )

    TARGET_LINK_LIBRARIES(${WALRUS_TARGET} PRIVATE
        ${WALRUS_LIBRARIES}
        ${WALRUS_LDFLAGS}
        # -fsanitize=fuzzer,address 가능
    )
    TARGET_COMPILE_OPTIONS(${WALRUS_TARGET} PRIVATE
