...
ELSEIF (${WALRUS_OUTPUT} MATCHES "fuzzer")
    ADD_EXECUTABLE (${FUZZER_TARGET} ${WALRUS_SRC_LIST} ${WALRUS_ROOT}/fuzz/fuzzer.cpp)
    ...
    if(ENABLE_PRINT_LOG)
        TARGET_COMPILE_DEFINITIONS (${FUZZER_TARGET} PRIVATE ${WALRUS_DEFINITIONS} PRINT_LOG)
    else()
